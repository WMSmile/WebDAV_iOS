...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImage *leftOff=[UIImage imageNamed:@"leftoff.png"];
        leftOff=[leftOff stretchableImageWithLeftCapWidth:3 topCapHeight:4];
        UIImage *leftOn=[UIImage imageNamed:@"lefton.png"];
        [leftOn stretchableImageWithLeftCapWidth:3 topCapHeight:4];
        [_left setImage:[UIImage imageNamed:@"thumbIcon.png"] forState:UIControlStateNormal];
        [_left setImage:[UIImage imageNamed:@"thumbIcon.png"] forState:UIControlStateHighlighted];
        [_left setImage:[UIImage imageNamed:@"thumbIcon.png"] forState:UIControlStateDisabled];
...
//        [_left setBackgroundImage:leftOn forState:UIControlStateSelected];
        ...
        UIImage *rightOff=[UIImage imageNamed:@"rightoff.png"];
        rightOff=[rightOff stretchableImageWithLeftCapWidth:3 topCapHeight:4];
        UIImage *rightOn=[UIImage imageNamed:@"righton.png"];
        [rightOn stretchableImageWithLeftCapWidth:3 topCapHeight:4];
        [_right setImage:[UIImage imageNamed:@"listIcon.png"] forState:UIControlStateNormal];
        [_right setImage:[UIImage imageNamed:@"listIcon.png"] forState:UIControlStateHighlighted];
        [_right setImage:[UIImage imageNamed:@"listIcon.png"] forState:UIControlStateDisabled];
